...
*  $$\label{Figure 9}\tag{Figure 9}$$: Feature importance analysis using Tree SHAP values *

Figure $$\ref{Figure 9}$$ shows that the feature $$work\_total$$ on (absolute) average added around 40 watts to the mean prediction value of the target variable $$avg\_power$$,
